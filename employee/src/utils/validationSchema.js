...
export const createVerifyEmailSchema = (t) => {
  return z.object({
    code1: z
      .number()
      .min(0)
      .max(9, { message: t("verifyEmail.codeField.validation.required") }),
...
export const createPersonalInfoSchema = (t) => {
  return z.object({
    services: z
      .string()
      .nonempty(t("personalInfo.services.validation.required")),
    Occupation: z
      .string()
      .nonempty(t("personalInfo.occupation.validation.required")),
  });
};
