...
const LanguageSwitcher = () => {
    ...
    return (
        <div className="language-switcher desktop-horizontal" role="group" aria-label="Language selection">
            {languages.map((lang) => (
                <button
                    key={lang.code}
                    onClick={() => changeLanguage(lang.code)}
                    className={`lang-btn ${i18n.language === lang.code ? 'active' : ''} ${isAnimating ? 'animating' : ''}`}
