...
const NoInterviews = () => {
    ...
    return (
        <section ref={ref} className="section-padding bg-gradient-to-br from-muted/30 to-background relative overflow-hidden">
            {/* Background Elements */}
                ...
                >
                    ...
                    <motion.div variants={itemVariants}>
                        ...
                        >
                            ...
                            <span className="text-sm font-medium text-accent">{t('noInterviews.stats')}</span>
                        </motion.div>
                        ...
                        >
                            <span className="text-gradient-hero">{t('noInterviews.title')}</span>
                        </motion.h2>
                        ...
                        >
                            ...
                            >
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <div className="font-semibold text-foreground text-sm">No Interviews</div>
                                        <div className="text-xs text-muted-foreground">Instant placement</div>
                                    </div>
                                </div>
                            </motion.div>
