...
const Rewards = () => {
  return (
    <div className="flex items-center justify-around Rewards flex-wrap max-[1041px]:flex-col mb-8 p-6 bg-white border border-gray-200 rounded-2xl shadow-xl transition-all duration-300 hover:shadow-2xl hover:-translate-y-0.5">
