                    ...
                    <div className="py-1" role="menu" aria-orientation="vertical">
                        {languages.map((language) => (
                            <button
                                ...
                                className={`flex items-center w-full px-4 py-2 text-sm text-left hover:bg-gray-100 ${i18n.language === language.code ? 'bg-indigo-50 text-indigo-700' : 'text-gray-700'
                                    }`}
                                role="menuitem"
                            >
