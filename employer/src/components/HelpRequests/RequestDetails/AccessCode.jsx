...
const AccessCode = ({ id, taskstatus }) => {
  ...
  return (
    <div className="fixed inset-0 w-full h-full z-[9999] flex justify-center items-center bg-[#28293d94] text-black overflow-hidden">
      <div
        className={`AccessCode w-[90vw] max-w-[600px] bg-white rounded-2xl p-5 mx-4 ${PinCode ? "h-[300px]" : "h-[600px]"
      ...
      >
        <div
          ...
          onClick={CodeClose}
        >
          <IoClose size={30} className="hover:bg-gray-100 rounded-full p-1 transition-colors duration-200" />
        </div>
